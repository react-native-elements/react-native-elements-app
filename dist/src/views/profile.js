...
import { StyleSheet, Text, View, SafeAreaView, Image, ScrollView, Dimensions, StatusBar } from "react-native";
...
const CustomButton = props => {
    ...
    const { title } = props;
    return (<Button title={title} titleStyle={{ fontSize: 15, color: "white", fontFamily: "regular" }} buttonStyle={selected
            ? {
            ...
            }} containerStyle={{ marginRight: 10 }} onPress={() => setSelected(!selected)}/>);
};
    ...
    return (<SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={{ flex: 1, backgroundColor: "rgba(47,44,60,1)" }}>
        ...
        <ScrollView style={{ flex: 1 }}>
          ...
          <Button containerStyle={{ marginVertical: 20 }} style={{
            flex: 1,
            justifyContent: "center",
            alignItems: "center"
        }} buttonStyle={{
        ...
        }} ViewComponent={LinearGradient} title="Message Theresa" titleStyle={{
            fontFamily: "regular",
            fontSize: 20,
            color: "white",
            textAlign: "center"
        }} onPress={() => console.log("Message Theresa")} activeOpacity={0.5}/>
        </ScrollView>
      </View>
    </SafeAreaView>);
};
