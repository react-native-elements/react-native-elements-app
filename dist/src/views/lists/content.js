        ...
        <View style={{
          ...
          <View style={{ flex: 3, flexDirection: 'row' }}>
            ...
            alignItems: 'center',
              ...
              <Avatar size={145} source={{
            uri: 'https://randomuser.me/api/portraits/men/1.jpg',
        }} activeOpacity={0.7} avatarStyle={{ borderRadius: 145 / 2 }} overlayContainerStyle={{ backgroundColor: 'transparent' }}/>
            </View>
            <View style={{
            flex: 1,
            justifyContent: 'center',
          ...
          <View style={{
            ...
            <View style={{ flex: 1, alignItems: 'center' }}>
              <Button title="View Profile" buttonStyle={{
            height: 33,
            width: 120,
            ...
            <View style={{ flex: 1, alignItems: 'center' }}>
              <Button title="Add User" buttonStyle={{
            height: 33,
            width: 120,
