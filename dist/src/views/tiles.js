...
const Tiles = () => {
    return (<>
      ...
      <View style={{ alignItems: "center" }}>
        <ScrollView>
        ...
        }} title="When I admire the wonders of a sunset or the beauty of the moon, my soul expands in the worship of the creator." titleStyle={{ fontSize: 20 }} featured caption="Mahatma Gandhi" activeOpacity={1} width={310}/>
          <View style={{ paddingTop: 20 }}>
            ...
            size: 60,
            color: "red"
        }} featured activeOpacity={0.8} onPress={() => {
            "Tile pressed";
        }} width={310}/>
          </View>
          <View style={{ paddingTop: 20 }}>
        ...
        }} title="Half Dome, Yosemite" titleStyle={{ fontSize: 20 }} activeOpacity={1} width={310} contentContainerStyle={{ height: 70 }}>
              <View style={{
            flex: 1,
            flexDirection: "row",
