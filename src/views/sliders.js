...
const Sliders = () => {
  ...
  const [upVal, setUpVal] = useState(20);
  const [downVal, setDownval] = useState(50);
    ...
    <>
      ...
      <View style={styles.verticalContent}>
        <Slider 
          ...
          thumbProps={{Component: Animated.Image, source: {uri: 'https://s3.amazonaws.com/uifaces/faces/twitter/ladylexy/128.jpg'}}}
        />
      </View>
