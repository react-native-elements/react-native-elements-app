...
const Lists2 = () => {
    const renderRow = ({ item }) => {
        return (<ListItem onPress={log} bottomDivider>
        <Icon name={item.icon}/>
        <ListItem.Content>
    ...
    return (<>
      ...
      <FlatList ListHeaderComponent={<>
            <View style={{ paddingVertical: 8 }}>
              {list2.map((l, i) => (<ListItem friction={90} tension={100} activeScale={0.95} key={i} linearGradientProps={{
                    colors: l.linearGradientColors,
                    start: [1, 0],
                    end: [0.2, 0],
                }} ViewComponent={LinearGradient} containerStyle={{
                    marginHorizontal: 16,
                    marginVertical: 8,
                    borderRadius: 8,
                }}>
            ...
            <View style={styles.list}>
              {list2.map((l, i) => (<ListItem key={i} onPress={log} bottomDivider>
            ...
            <View style={styles.list}>
              {list2.map((l, i) => (<ListItem key={i} bottomDivider>
          ...
          </>} data={list1} keyExtractor={(a) => a.title} renderItem={renderRow}/>
    </>);
};
